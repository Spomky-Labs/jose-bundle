Feature: This bundle provides a service able to create JWS
  ...
  Scenario: I can create a JWS in JSON Flattened Serialization Mode
    ...
    Hello World!
    """
    When I try to create a JWS in JSON Flattened Serialization Mode with signature key "jose.key.key0" and I store the result in the variable "jws_compact"
    Then the variable "jws_compact" should be a string with value '{"payload":"SGVsbG8gV29ybGQh","protected":"eyJhbGciOiJIUzUxMiJ9","signature":"Q2THrV6jf_V9Ad-cMMkcMfagBhIME6OEOjxbksQSacDY591l9KKiaPv4aoiSk0wpqMftxE8LFJKc6qPz3nnaHQ"}'
